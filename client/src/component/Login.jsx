...
>
  <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md space-y-6 relative overflow-hidden">
    ...
    <div className="text-center mb-2">
      <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-pink-600 bg-clip-text text-transparent">Echoo- A Chat App</h1>
      <p className="text-gray-500 text-sm mt-1">Connect with friends instantly</p>
    </div>
